...
def language_operations(mode, expansion_limit, base_length):
   ...
   if base_length == 0:
      if mode == 0:
         ...
         topic_tags.append(['natur', 'plain', 'lie', 'elsewher', 'getter', 'pod', 'bring', 'rc', 'setter', 'aim', 'ton', 'toolchain', 'wstring', 'flash', 'raii', 'reload', 'licens', 'modal', 'chat', 'crc'])
         ...
         topic_tags.append(['eclips', 'whose', 'hyperlink', 'spot', 'yellow', 'grow', 'manner', 'hierarchi', 'degre', 'theori', 'divis', 'travers', 'viewer', 'sandbox', 'dirti', 'paint', 'overwritten', 'webgl', 'six', 'credit'])
